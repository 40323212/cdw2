...
@scrum1_task40323212.route('/scrum1_12_ABCD')
def scrum1_12_ABCD():
    outstring = '''
<!DOCTYPE html>
<html>
...
@scrum1_task40323212.route('/scrum1_12_B')
def scrum1_12_B():
    outstring = '''
...
@scrum1_task40323212.route('/scrum1_12_C')
def scrum1_12_C():
    outstring = '''
...
@scrum1_task40323212.route('/scrum1_12_D')
def scrum1_12_D():
    outstring = '''
